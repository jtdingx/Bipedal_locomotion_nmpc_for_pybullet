...
// const int _nsum = 100; /// number of whole control loop
...
public:
    ...
    void CoM_foot_gen_end(int i);
    void CoM_foot_gen_stopx(int i);
	...
	Vector3d XGetSolution_CoM_position(int walktime, double dt_sample, int t_int, Eigen::Vector3d body_in1, Eigen::Vector3d body_in2, Eigen::Vector3d body_in3);
	Vector3d XGetSolution_Foot_positionR(int walktime, double dt_sample, int t_int, Eigen::Vector3d body_in1, Eigen::Vector3d body_in2, Eigen::Vector3d body_in3);
	Vector3d XGetSolution_Foot_positionL(int walktime, double dt_sample, int t_int, Eigen::Vector3d body_in1, Eigen::Vector3d body_in2, Eigen::Vector3d body_in3);	
	Vector3d XGetSolution_body_inclination(int walktime, double dt_sample, int t_int, Eigen::Vector3d body_in1, Eigen::Vector3d body_in2, Eigen::Vector3d body_in3);
    ...
    void File_wlxx();
	void File_wl(std::string file_name, MatrixXd data_save);	
    int read_scanf(const string &filename, const int &cols, vector<double *> &_vector);
    MatrixXd rea_save(std::string file_name, int rowNum);
...
////////// generate the COM trajectory during the DSP
	...
	MatrixXd _mpccontrol_state,_mpccontrol_com,_mpccontrol_com1;
	std::string file_mpc,file_mpcx,file_mpcy;
	
	int _mpc_starowNum, _mpc_sta_colNum,_mpc_starowNum1,_mpc_starowNum2;
